                ...
                <div className="post-block">
                    <div className="d-flex justify-content-between">
                        <div className="d-flex mb-3">
                            <div className="mr-2">
                                <a href="#!" className="text-dark"><img src="img/user1.jpg" alt="User" className="author-img"/></a>
                            </div>
                            <div>
                        ...
                        <div className="post-block__user-options">
                            ...
                            <div className="dropdown-menu dropdown-menu-right" aria-labelledby="triggerId">
                                <a className="dropdown-item text-dark" href="#!"><i className="fa fa-pencil mr-1"></i>Edit</a>
                    ...
                    <div className="mb-3">
                        <div className="d-flex justify-content-between mb-2">
                            <div className="d-flex">
                                <a href="#!" className="text-danger mr-2"><span><i className="fa fa-heart"></i></span></a>
                                <a href="#!" className="text-dark mr-2"><span>Comment</span></a>
                            </div>
                    ...
                    <div className="post-block__comments">
                        ...
                        <div className="comment-view-box mb-3">
                            <div className="d-flex mb-2">
                                <img src="img/user2.jpg" alt="User img" className="author-img author-img--small mr-2"/>
                                <div>
                                    ...
                                    <div className="d-flex">
                                        <a href="#!" className="text-dark mr-2"><span><i className="fa fa-heart-o"></i></span></a>
                                        <a href="#!" className="text-dark mr-2"><span>Reply</span></a>
                                    </div>
                                </div>
                            </div>
                        </div>
